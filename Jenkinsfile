			...
			stage('Scan Docker Image') {
				try {
					sh """
						...
						GRYPE_MATCH_GOLANG_USING_CPES=false /usr/local/bin/grype oci-archive:/tmp/image.tar -f high --only-fixed -o template --file report.html -t grype.tmpl -c .grype.yaml
					"""
				} catch (error) {
